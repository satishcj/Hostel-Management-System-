                ...
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form"  method="post">
						    ...
						    <a href="forgetpsw.php" class="btn btn-lg btn-success btn-block"><i class="ace-icon fa fa-arrow-left"></i>I forget my password</a>
						    <a href="register.php" class="btn btn-lg btn-success btn-block"><i class="ace-icon fa fa-arrow-left"></i>I want to register</a>
                            </fieldset>
                        </form>
                    </div>
                </div>
